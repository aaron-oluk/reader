...
public class SignatureProcessor {
    ...
    public static Bitmap processSignature(Bitmap originalBitmap, int sensitivity) {
        ...
        // Convert sensitivity (0-100) to threshold (higher sensitivity = lower threshold)
        // Threshold range: 200 (low sensitivity) to 100 (high sensitivity)
        int threshold = 200 - (sensitivity);
        ...
        for (int i = 0; i < pixels.length; i++) {
            ...
            if (luminance > threshold) {
                ...
                // This is likely ink - make it black
